...
- You are already [running a Taiko node](/src/content/docs/guides/run-a-taiko-node.mdx).
...
1. First, you will need to have a prover from [the marketplace](/src/content/docs/resources/prover-marketplace.md) or [run your own SGX prover](/src/content/docs/guides/enable-a-prover.mdx).
