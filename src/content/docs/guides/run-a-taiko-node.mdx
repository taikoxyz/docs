...
Form: https://forms.gle/qquRq3cnGbyneV9S6

Follow the guide here:
 
- Raiko docker tutorial: https://github.com/johntaiko/zeth/blob/feat/taiko/README_Docker.md
- Docker compose: https://github.com/johntaiko/zeth/blob/feat/taiko/docker/docker-compose-pos.yml
- Running docker with `--init` will do the bootstrap: https://github.com/johntaiko/zeth/blob/feat/taiko/docker/entrypoint.sh
