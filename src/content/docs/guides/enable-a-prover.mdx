...
1. A Taiko prover needs to be able to generate SGX proofs at the moment. Please follow the README guide on our <a href="https://github.com/taikoxyz/raiko/blob/taiko/unstable/docs/README_Docker_and_RA.md" target="_blank" rel="noopener noreferrer">raiko</a> repository.
...
1. Approve the TaikoL1 contract as a spender.
    ...
    Visit the TTKOh contract on Holesky <a href="https://holesky.etherscan.io/address/0x6490E12d480549D333499236fF2Ba6676C296011#writeProxyContract" target="_blank" rel="noopener noreferrer">here</a>.
