...
1. A Taiko prover needs to be able to generate SGX proofs at the moment. Please follow the README guide on our [raiko](https://github.com/taikoxyz/raiko/blob/taiko/unstable/docs/README_Docker_and_RA.md) repository.
